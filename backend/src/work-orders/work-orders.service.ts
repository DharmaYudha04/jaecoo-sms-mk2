    ...
    return this.prisma.$transaction(async (tx) => {
      ...
      await tx.workOrder.update({
        ...
        data: {
          ...
          no_rangka:
            body.no_rangka ?? body.vehicle?.no_rangka ?? existing.no_rangka,
        },
      });
      ...
      if (existingService) {
        await tx.servis.update({
          ...
          data: {
            ...
            statusCuciMobil:
              body.servis?.statusCuciMobil ?? existingService.statusCuciMobil,
            catatanCuciMobil:
              body.servis?.catatanCuciMobil !== undefined
                ? body.servis.catatanCuciMobil?.trim() || null
                : existingService.catatanCuciMobil,
          },
        });
