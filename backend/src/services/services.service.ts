    ...
    return this.prisma.$transaction(async (tx) => {
      ...
      if (nextStatus === 'DIAMBIL' && nextWashStatus === 'MENUNGGU') {
        throw new BadRequestException(
          'Mobil tidak dapat ditandai diambil selama permintaan cuci mobil masih menunggu.',
        );
      }
      ...
      await tx.servis.update({
        ...
        data: {
          ...
          catatanCuciMobil:
            body.catatanCuciMobil !== undefined
              ? body.catatanCuciMobil?.trim() || null
              : existing.catatanCuciMobil,
          tanggalSelesai:
