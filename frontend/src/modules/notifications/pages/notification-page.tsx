  ...
  const openNotification = async (item: AppNotification) => {
    ...
    try {
      ...
      showToast({
        ...
        description: getErrorMessage(error, 'Notifikasi tidak berhasil dibuka.'),
        tone: 'error',
      });
    } finally {
    ...
    <div className="space-y-5">
        ...
        actions={
          <>
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  showToast({
                    ...
                    description: getErrorMessage(error, 'Terjadi kesalahan saat menghapus notifikasi.'),
                    tone: 'error',
                  });
                }
              }}
            ...
            <Button
              ...
              disabled={!hasNotifications || markAllMutation.isPending || clearNotificationsMutation.isPending}
            >
      ...
      <Card className="grid gap-3 md:grid-cols-[1.6fr_0.8fr_0.8fr]">
        <form onSubmit={submitSearch} className="flex items-center gap-2">
          ...
          <Button
            ...
            aria-label="Telusuri notifikasi"
      ...
      <Card className="space-y-3">
        {notificationsQuery.isLoading ? (
          <LoadingState message="Memuat notifikasi..." rows={4} />
        ) : notificationsQuery.isError ? (
          <EmptyState message={getErrorMessage(notificationsQuery.error, 'Gagal memuat notifikasi.')} />
          ...
          <div className="space-y-4">
                  ...
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    ...
                    <div className="flex shrink-0 flex-wrap items-center gap-2">
                      <Button
                        ...
                        aria-label={
                          item.isRead
                            ? `Notifikasi ${item.title} sudah dibaca`
                            : `Tandai notifikasi ${item.title} sebagai dibaca`
                        }
                        ...
                        onClick={async () => {
                          ...
                          try {
                            ...
                            showToast({
                              ...
                              description: 'Status notifikasi telah diperbarui.',
                              tone: 'success',
                            });
                          } catch (error) {
                            if (isAlreadyHandledElsewhere(error)) {
                              showToast({
                                title: 'Notifikasi sudah diperbarui',
                              ...
                              showToast({
                                ...
                                description: getErrorMessage(error, 'Notifikasi tidak berhasil ditandai sebagai dibaca.'),
                                tone: 'error',
                              });
                            }
                          } finally {
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          ...
                          try {
                            ...
                            showToast({
                              title: 'Notifikasi dihapus',
                              description: 'Notifikasi telah dihapus dari akun Anda.',
                              tone: 'success',
                            });
                            ...
                            if (isAlreadyHandledElsewhere(error)) {
                              showToast({
                                title: 'Notifikasi sudah tidak tersedia',
                              ...
                              showToast({
                                title: 'Gagal menghapus notifikasi',
                                description: getErrorMessage(error, 'Notifikasi tidak berhasil dihapus.'),
                                tone: 'error',
                              });
                            }
                          } finally {
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 rounded-[20px] border border-[color:var(--line)] bg-[color:var(--panel-light)] px-4 py-3 text-sm theme-muted">
              <span>
                Halaman {currentPage} dari {totalPages} • {notifications.length} data
              </span>
